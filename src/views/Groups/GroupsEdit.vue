<template>
    <div class="w-4/5 mx-auto py-12 my-5">
        <h1 class="text-center text-white">Groups Edit</h1>
        <div class="mb-3">
            <RouterLink :to="{ name: 'groups', params: { id: groupId } }" class="border px-3 py-1 text-white">Back</RouterLink>
        </div>
...
<script>
    import { editGroup } from '@/api/payshare-api';
...
export default {
    ...
    methods: {
        async editGroup() {
            const response = await editGroup(group_name.value);
